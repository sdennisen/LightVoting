...
package org.lightvoting.simulation.environment.coordinated_iterative;
 ...
 * Environment class
 */
public final class CEnvironmentCI
{
    private List<CGroupCI>  m_groups = Collections.synchronizedList( new LinkedList<>() );
    private int m_groupNum;
    private List<CVotingAgentCI> m_agentList = new LinkedList<>();
     ...
     */
    public CEnvironmentCI( final int p_size, final String p_fileName, final int p_capacity )
    {
     ...
     *
     */
    public final void initialset( final CVotingAgentCI p_votingAgent )
    {
        m_agentList.add( p_votingAgent );

        if  ( !m_firstActivated )
        {
            final CVotingAgentCI l_firstAgent = m_agentList.get( 0 );
     ...
     */
    public ILiteral literal( final CVotingAgentCI p_votingAgent )
    {
...
//     * @return new group
//     */
//    public CGroupCI openNewGroupRandom( final CVotingAgentCI p_votingAgent )
//    {
//        final CGroupCI l_group = new CGroupCI( p_votingAgent, "RANDOM", m_groupNum, m_capacity );
...
//     * @return new group
//     */
//    public CGroupCI openNewGroupCoordinated( final CVotingAgentCI p_votingAgent )
//    {
//        final CGroupCI l_group = new CGroupCI( p_votingAgent, "COORDINATED", m_groupNum, m_capacity );
//        m_groups.add( l_group );
//        System.out.println( "Created Group " + l_group );
//
//   //      EDataWriter.INSTANCE.setGroup( m_run, m_config, m_groupNum );
...
//     */
//
//    public void addAgentRandom( final CGroupCI p_randomGroup, final CVotingAgentCI p_votingAgent )
//    {
...
//
//
//    public void addAgentCoordinated( final CGroupCI p_group, final CVotingAgentCI p_votingAgent )
//    {
...
//     */
//    public void reopen( final CGroupCI p_group )
//    {
//        p_group.reopen();
//        this.wakeUpAgent();
//    }
    ...
    {
        m_currentIndex++;
        final CVotingAgentCI l_wakingAgent =  m_agentList.get( m_currentIndex );
