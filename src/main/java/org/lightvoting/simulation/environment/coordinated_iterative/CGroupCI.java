 ...
 */
public class CGroupCI
{
    private final HashMap<String, CVotingAgentCI> m_agentMap = new HashMap<>();

    private final int m_capacity;

    private final CChairAgentCI m_chair;
     ...
     */
    public CGroupCI( final CVotingAgentCI p_votingAgent,
                     final CChairAgentCI p_chair,
     ...
     */
    public void add( final CVotingAgentCI p_votingAgent, final long p_cycle )
    {
        m_agentMap.put( p_votingAgent.name(), p_votingAgent );
...
//    }
     ...
     * @return agent stream
     */
    public Stream<CVotingAgentCI> agents()
    {
        return m_agentMap.values().stream();
    }

    public void remove( final CVotingAgentCI p_votingAgent )
    {
...
//     */
//    public void addRandom( final CVotingAgentCI p_votingAgent )
//    {
...
//     */
//
//    public void addCoordinated( final CVotingAgentCI p_votingAgent )
//    {
//
//        System.out.println( "Adding agent, old size is " + m_agentMap.size() );
//        m_agentMap.put( p_votingAgent.name(), p_votingAgent );
...
//     */
//    public CVotingAgentCI determineAgent( final String p_agentName )
//    {
