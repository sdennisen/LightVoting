 ...
 * Environment class
 */
public final class CEnvironmentCB
{
    private List<CGroupCB>  m_groups = Collections.synchronizedList( new LinkedList<>() );
    private int m_groupNum;
    private List<CVotingAgentCB> m_agentList = new LinkedList<>();
     ...
     */
    public CEnvironmentCB( final int p_size, final String p_fileName, final int p_capacity )
    {
     ...
     *
     */
    public final void initialset( final CVotingAgentCB p_votingAgent )
    {
        m_agentList.add( p_votingAgent );

        if  ( !m_firstActivated )
        {
            final CVotingAgentCB l_firstAgent = m_agentList.get( 0 );
     ...
     */
    public ILiteral literal( final CVotingAgentCB p_votingAgent )
    {
...
//     * @return new group
//     */
//    public CGroupCB openNewGroupRandom( final CVotingAgentCB p_votingAgent )
//    {
//        final CGroupCB l_group = new CGroupCB( p_votingAgent, "RANDOM", m_groupNum, m_capacity );
...
//     * @return new group
//     */
//    public CGroupCB openNewGroupCoordinated( final CVotingAgentCB p_votingAgent )
//    {
//        final CGroupCB l_group = new CGroupCB( p_votingAgent, "COORDINATED", m_groupNum, m_capacity );
//        m_groups.add( l_group );
//        System.out.println( "Created Group " + l_group );
//
//   //      EDataWriter.INSTANCE.setGroup( m_run, m_config, m_groupNum );
...
//     */
//
//    public void addAgentRandom( final CGroupCB p_randomGroup, final CVotingAgentCB p_votingAgent )
//    {
...
//
//
//    public void addAgentCoordinated( final CGroupCB p_group, final CVotingAgentCB p_votingAgent )
//    {
...
//     */
//    public void reopen( final CGroupCB p_group )
//    {
//        p_group.reopen();
//        this.wakeUpAgent();
//    }
    ...
    {
        m_currentIndex++;
        final CVotingAgentCB l_wakingAgent =  m_agentList.get( m_currentIndex );
