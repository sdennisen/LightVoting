 ...
 */
public class CGroupCB
{
    private final HashMap<String, CVotingAgentCB> m_agentMap = new HashMap<>();

    private final int m_capacity;

    private final CChairAgentCB m_chair;
     ...
     */
    public CGroupCB( final CVotingAgentCB p_votingAgent,
                     final CChairAgentCB p_chair,
     ...
     */
    public void add( final CVotingAgentCB p_votingAgent, final long p_cycle )
    {
        m_agentMap.put( p_votingAgent.name(), p_votingAgent );
...
//    }
     ...
     * @return agent stream
     */
    public Stream<CVotingAgentCB> agents()
    {
...
//     */
//    public void addRandom( final CVotingAgentCB p_votingAgent )
//    {
...
//     */
//
//    public void addCoordinated( final CVotingAgentCB p_votingAgent )
//    {
//
//        System.out.println( "Adding agent, old size is " + m_agentMap.size() );
//        m_agentMap.put( p_votingAgent.name(), p_votingAgent );
...
//    }
//
//    public void remove( final CVotingAgentCB p_votingAgent )
//    {
...
//     */
//    public CVotingAgentCB determineAgent( final String p_agentName )
//    {
