...
package org.lightvoting.simulation.action.message.random_iterative;
 ...
 */
public final class CSendRI extends IBaseAction
{
    /**
     * serialUID
     */
     ...
     */
    private final Map<String, CVotingAgentRI> m_agents = new ConcurrentHashMap<>();

    /** Register a new agent.
     * @param p_agent agent object
     * @return object of registered agent
     */
    public final CVotingAgentRI register( final CVotingAgentRI p_agent )
    {
     ...
     */
    public final CVotingAgentRI unregister( final CVotingAgentRI p_agent )
    {
        ...
        l_receiver.trigger(
                CTrigger.from(
                        ...
                        CLiteral.from(
                                ...
                                CLiteral.from( "from", CRawTerm.from( p_context.agent().<CVotingAgentRI>raw().name() ) )
                        )
