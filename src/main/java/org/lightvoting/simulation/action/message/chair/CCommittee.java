...
package org.lightvoting.simulation.action.message.chair;
...
//
///**
// * Action to send from the chair the computed committee (set of POIs) to the voting agents.
// */
...
//    {
//        return CPath.from( "voting/send/voter/committee" );
//    }
//
//    @Override
