...
package org.lightvoting.simulation.action.message.coordinated_basic;
 ...
 */
public final class CSendCB extends IBaseAction
{
    /**
     * serialUID
     */
     ...
     */
    private final Map<String, CVotingAgentCB> m_agents = new ConcurrentHashMap<>();

    /** Register a new agent.
     * @param p_agent agent object
     * @return object of registered agent
     */
    public final CVotingAgentCB register( final CVotingAgentCB p_agent )
    {
     ...
     */
    public final CVotingAgentCB unregister( final CVotingAgentCB p_agent )
    {
        ...
        l_receiver.trigger(
                CTrigger.from(
                        ...
                        CLiteral.from(
                                ...
                                CLiteral.from( "from", CRawTerm.from( p_context.agent().<CVotingAgentCB>raw().name() ) )
                        )
