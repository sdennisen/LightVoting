...
// */
//@IAgentAction
//public class CBrokerAgent_old extends IBaseAgent<CBrokerAgent_old>
//{
...
//     */
//    public CBrokerAgent_old( final String p_broker,
...
//     */
//    public static class CBrokerAgentGenerator extends IBaseAgentGenerator<CBrokerAgent_old>
//    {
//
//        /**
...
//                            CCommon.actionsFromAgentClass( CBrokerAgent_old.class ),
...
//
//            System.out.println( "actions defined in broker class: " + CCommon.actionsFromAgentClass( CBrokerAgent_old.class ).collect( Collectors.toSet() ) );
//
//
...
//        @Nullable
//        @Override
//        public CBrokerAgent_old generatesingle( @Nullable final Object... p_data )
//        {
//            CBrokerAgent_old l_broker = null;
//            try
//            {
//                l_broker = new CBrokerAgent_old(
//
